...
import 'package:helpfortrauma/core/utils/colorful_tag.dart';
import 'package:helpfortrauma/models/recent_user_model.dart';
      ...
      DataCell(
        Row(
          children: [
            ...
            ElevatedButton.icon(
              style: ElevatedButton.styleFrom(
                foregroundColor: Colors.green.withOpacity(0.5),
              ),
              icon: Icon(
                Icons.visibility,
                size: 14,
